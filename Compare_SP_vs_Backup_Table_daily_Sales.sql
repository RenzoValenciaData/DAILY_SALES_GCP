...
SELECT 
  a.*
  ,b.Sell_In_Tons - a.Sell_In_Tons AS Diff_Sell_in_Tons
  ,b.sell_In_Gross_Sales - a.Sell_In_Gross_Sales AS Diff_Sell_In_GS
  ,b.sell_In_NR - a.Sell_In_NR AS Diff_Sell_In_NR
FROM `dev-amer-analyt-actuals-svc-7a.amer_p_la_fin_data_hub.t_fct_daily_sales_la_test` a
LEFT JOIN `dev-amer-analyt-actuals-svc-7a.amer_p_la_fin_data_hub.t_fct_daily_sales_la_backup` b ON a.posting_date = b.posting_date
  AND a.sku_code = b.sku_code
  AND a.market = b.market
  AND a.billing_type = b.billing_type
  AND a.record_type = b.record_type
where (b.Sell_In_Tons - a.Sell_In_Tons != 0 OR b.sell_In_Gross_Sales - a.Sell_In_Gross_Sales != 0 OR b.sell_In_NR - a.Sell_In_NR != 0)